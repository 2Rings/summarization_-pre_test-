...
tf.app.flags.DEFINE_string('pretrain_word', '', 'Path to pretrain word embedding')
# Important settings
...
def main(unused_argv):
  ...
  vocab = Vocab(FLAGS.vocab_path, FLAGS.pretrain_word, FLAGS.vocab_size) # create a vocabulary
  ...
  for key in hparam_list:
      if hasattr(FLAGS, key):
          hps_dict[key] = getattr(FLAGS, key)
